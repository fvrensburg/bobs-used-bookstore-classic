...
{
    /// <summary>
    /// Seeds the database with initial reference data and books if the tables are empty.
    /// Replaces the EF6 DropCreateDatabaseIfModelChanges initializer with a safe, additive seeder.
    /// </summary>
